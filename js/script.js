...
;
var menu_btn = document.querySelector('.btn-menu__btn');
menu_btn.addEventListener('click', function (e) {
  var menu_body = document.querySelector('.btn-menu__body');
  var menu_icon = document.querySelector('.btn-menu__icon');
  menu_body.classList.toggle('_active');
  menu_icon.classList.toggle('_active');
  document.body.classList.toggle('_lock');
});
var menu_btnScroll = document.querySelector('.btn-menu__btn-scroll');
menu_btnScroll.addEventListener('click', function (e) {
  var menu_scroll = document.querySelector('.scroll__menu');
  var menu_icon = document.querySelector('.btn-menu__icon-scroll');
  menu_scroll.classList.toggle('_active');
  menu_icon.classList.toggle('_active');
  document.body.classList.toggle('_lock');
});
document.documentElement.addEventListener("click", function (e) {
  if (document.documentElement.clientWidth >= 769) {
    if (!e.target.closest('.btn-menu__container')) {
      var menu_scroll = document.querySelector('.scroll__menu');
      var menu_iconScroll = document.querySelector('.btn-menu__icon-scroll');
      menu_scroll.classList.remove('_active');
      menu_iconScroll.classList.remove('_active');
...
var close_btn = document.querySelector('.body-menu-cat__close');
...
var close_btnScroll = document.querySelector('.body-menu-cat__close-scroll');
close_btnScroll.addEventListener('click', function (e) {
  var menu_icon = document.querySelector('.btn-menu__icon-scroll');
  var menu_scroll = document.querySelector('.scroll__menu');
  menu_scroll.classList.remove('_active');
  menu_icon.classList.remove('_active');
...
var menuArrow = document.querySelectorAll('.menu-category__arrow');

if (menuArrow.length > 0) {
  for (var i = 0; i < menuArrow.length; i++) {
    var menuArr = menuArrow[i];
    menuArrow.forEach(function (menuArr) {
      menuArr.addEventListener('click', function (e) {
        menuArrow.forEach(function (el) {
...
document.documentElement.addEventListener("click", function (e) {
  ...
  if (!e.target.closest('.menu-category__li')) {
...
$(document).ready(function () {
  $('.home-products__items').isotope({
    itemSelector: '.item-product__wrapper'
  });
...
var cart_icon = document.querySelector('.top-content__cart');
...
document.documentElement.addEventListener("click", function (e) {
  if (!e.target.closest('.top-content__cart-wrapper')) {
    var closeCart = document.querySelector('.top-content__cart-home');
    closeCart.classList.remove('_active');
  }
});

if (document.querySelector('.cart-home__close')) {
...
var bodyPopups = document.querySelector('body');
...
function bodyLock() {
  ...
  bodyPopups.style.paddingRight = lockPaddingValue;
  bodyPopups.classList.add('_lock-popup');
  unlock = false;
  setTimeout(function () {
    unlock = true;
  }, timeout);
...
function bodyUnlock() {
  setTimeout(function () {
    ...
    bodyPopups.style.paddingRight = '0px';
    bodyPopups.classList.remove('_lock-popup');
  }, timeout);
  unlock = false;
  setTimeout(function () {
    unlock = true;
...
DynamicAdapt.prototype.init = function () {
  ...
  var _loop3 = function _loop3(_i4) {
    var media = _this2.mediaQueries[_i4];
  ...
  for (var _i4 = 0; _i4 < this.mediaQueries.length; _i4++) {
    _loop3(_i4);
  }
};
...
DynamicAdapt.prototype.mediaHandler = function (matchMedia, оbjects) {
  if (matchMedia.matches) {
    for (var _i5 = 0; _i5 < оbjects.length; _i5++) {
      var оbject = оbjects[_i5];
      оbject.index = this.indexInParent(оbject.parent, оbject.element);
      this.moveTo(оbject.place, оbject.element, оbject.destination);
    }
  } else {
    for (var _i6 = 0; _i6 < оbjects.length; _i6++) {
      var _оbject = оbjects[_i6];
